...
public class GSMEncoderFormatConversionProviderTest extends AbstractGsmFormatConversionProviderTest {
    ...
    public void testIsSourceEncodingSupportedEncoding() {
        ...
        List<Encoding> expectedUnsupportedEncodings = Arrays.asList(
                null, PCM_UNSIGNED, TOAST_GSM_ENCODING, MS_GSM_ENCODING, ALAW, ULAW);
    ...
    public void testIsTargetEncodingSupportedEncoding() {
        List<Encoding> expectedSupportedEncodings = List.of(TOAST_GSM_ENCODING, MS_GSM_ENCODING);
        List<Encoding> expectedUnsupportedEncodings = Arrays.asList(null, PCM_SIGNED, PCM_UNSIGNED, ALAW, ULAW);
    ...
    public void testGetTargetEncodingsAudioFormat() {
        testGetTargetEncodingsAudioFormat(
                ...
                List.of(TOAST_GSM_ENCODING, MS_GSM_ENCODING),
                List.of(PCM_UNSIGNED, ALAW, ULAW));
        testGetTargetEncodingsAudioFormat(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, false),
                List.of(TOAST_GSM_ENCODING, MS_GSM_ENCODING),
                List.of(PCM_UNSIGNED, ALAW, ULAW));
        testGetTargetEncodingsAudioFormat(
                new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, NOT_SPECIFIED, 50.0F, true),
                EMPTY_ENCODING_LIST,
                List.of(PCM_SIGNED, PCM_UNSIGNED, ALAW, ULAW, TOAST_GSM_ENCODING, MS_GSM_ENCODING));
        testGetTargetEncodingsAudioFormat(
                new AudioFormat(MS_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, NOT_SPECIFIED, 25.0F, true),
                EMPTY_ENCODING_LIST,
                List.of(PCM_SIGNED, PCM_UNSIGNED, ALAW, ULAW, TOAST_GSM_ENCODING, MS_GSM_ENCODING));
    }
    ...
    public void testIsConversionSupportedEncodingAudioFormat() {
        testIsConversionSupportedEncodingAudioFormat(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, true),
                List.of(TOAST_GSM_ENCODING, MS_GSM_ENCODING),
                List.of(PCM_SIGNED, PCM_UNSIGNED, ALAW, ULAW));
        testIsConversionSupportedEncodingAudioFormat(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, false),
                List.of(TOAST_GSM_ENCODING, MS_GSM_ENCODING),
                List.of(PCM_SIGNED, PCM_UNSIGNED, ALAW, ULAW));
    ...
    public void testGetTargetFormatsEncodingAudioFormat() {
        testGetTargetFormatsEncodingAudioFormat(TOAST_GSM_ENCODING,
                ...
                List.of(new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, ALL, 1, 33, 50.0F, true),
                        new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, ALL, 1, 33, 50.0F, false)),
                EMPTY_AUDIOFORMAT_LIST);
        testGetTargetFormatsEncodingAudioFormat(MS_GSM_ENCODING,
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, true),
                List.of(new AudioFormat(MS_GSM_ENCODING, 8000.0F, ALL, 1, 65, 25.0F, true),
                        new AudioFormat(MS_GSM_ENCODING, 8000.0F, ALL, 1, 65, 25.0F, false)),
                EMPTY_AUDIOFORMAT_LIST);
    }
    ...
    public void testIsConversionSupportedAudioFormatAudioFormat() {
        testIsConversionSupportedAudioFormatAudioFormat(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, true),
                List.of(new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 33, 50.0F, true),
    ...
    public void testGetAudioInputStreamEncodingAudioInputStream() {
        ...
        testGetAudioInputStreamEncodingUnsupported(TOAST_GSM_ENCODING,
                new AudioFormat(PCM_UNSIGNED, 8000.0F, 16, 1, 2, 8000.0F, true), NOT_SPECIFIED);
        // wrong source number of channels
        testGetAudioInputStreamEncodingUnsupported(TOAST_GSM_ENCODING,
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 2, 4, 8000.0F, true), NOT_SPECIFIED);
        // wrong source sample rate
        testGetAudioInputStreamEncodingUnsupported(TOAST_GSM_ENCODING,
                new AudioFormat(PCM_SIGNED, 44100.0F, 16, 1, 2, 44100.0F, true), NOT_SPECIFIED);
        // wrong source sample size
        testGetAudioInputStreamEncodingUnsupported(TOAST_GSM_ENCODING,
                new AudioFormat(PCM_SIGNED, 8000.0F, 8, 1, 1, 8000.0F, true), NOT_SPECIFIED);

        // wrong source and target encodings
        testGetAudioInputStreamEncodingUnsupported(PCM_SIGNED,
                new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 33, 50, true), NOT_SPECIFIED);
        testGetAudioInputStreamEncodingUnsupported(PCM_SIGNED,
                new AudioFormat(MS_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 65, 25, true), NOT_SPECIFIED);
    }
    ...
    public void testGetAudioInputStreamAudioFormatAudioInputStream() {
        testGetAudioInputStreamAudioFormat(
                new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 33, 50.0F, false),
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, false),
                NOT_SPECIFIED,
                new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 33, 50.0F, false),
                NOT_SPECIFIED);
        ...
        testGetAudioInputStreamAudioFormatUnsupported(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, false),
                new AudioFormat(TOAST_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 33, 50, true),
                NOT_SPECIFIED);
        testGetAudioInputStreamAudioFormatUnsupported(
                new AudioFormat(PCM_SIGNED, 8000.0F, 16, 1, 2, 8000.0F, false),
                new AudioFormat(MS_GSM_ENCODING, 8000.0F, NOT_SPECIFIED, 1, 65, 25, true),
                NOT_SPECIFIED);
    }
}
