...
public class Buffer {
    ...
    public void writeInit() {
        if (TDebug.TraceOggNative) { TDebug.out("writeInit: begin"); }
        OggLibrary.INSTANCE.oggpack_writeinit(handle);
        if (TDebug.TraceOggNative) { TDebug.out("writeInit: end"); }
    }
    ...
    public void writeTrunc(int nBits) {
        if (TDebug.TraceOggNative) { TDebug.out("writeTrunc: begin"); }
        OggLibrary.INSTANCE.oggpack_writetrunc(handle, new NativeLong(nBits));
        if (TDebug.TraceOggNative) { TDebug.out("writeTrunc: end"); }
    }
    ...
    public void writeAlign() {
        if (TDebug.TraceOggNative) { TDebug.out("writeAlign: begin"); }
        OggLibrary.INSTANCE.oggpack_writealign(handle);
        if (TDebug.TraceOggNative) { TDebug.out("writeAlign: end"); }
    }
    ...
    public void writeClear() {
        if (TDebug.TraceOggNative) { TDebug.out("writeClear: begin"); }
        OggLibrary.INSTANCE.oggpack_writeclear(handle);
        if (TDebug.TraceOggNative) { TDebug.out("writeClear: end"); }
    }
    ...
    public void readInit(byte[] abBuffer, int nBytes) {
        if (TDebug.TraceOggNative) { TDebug.out("readInit: begin"); }
        if (TDebug.TraceOggNative) { TDebug.out(String.format("readInit: nBytes: %d", nBytes)); }
        ByteBuffer buffer = ByteBuffer.allocate(abBuffer.length);
        if (TDebug.TraceOggNative) { TDebug.out(String.format("readInit: buffer[0]: %d", buffer.get(0))); }
        if (TDebug.TraceOggNative) { TDebug.out(String.format("readInit: buffer[1]: %d", buffer.get(1))); }
        if (TDebug.TraceOggNative) { TDebug.out(String.format("readInit: buffer[2]: %d", buffer.get(2))); }
        OggLibrary.INSTANCE.oggpack_readinit(handle, buffer, nBytes);
        buffer.get(abBuffer);
        if (TDebug.TraceOggNative) { TDebug.out("readInit: end"); }
    }
    ...
    public int look(int nBits) {
        if (TDebug.TraceOggNative) { TDebug.out("look: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_look(handle, nBits);
        if (TDebug.TraceOggNative) { TDebug.out("look: end"); }
     ...
     */
    public int look1() {
        if (TDebug.TraceOggNative) { TDebug.out("look1: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_look1(handle);
        if (TDebug.TraceOggNative) { TDebug.out("look1: end"); }
        return nReturn.intValue();
    }
    ...
    public void adv(int nBits) {
        if (TDebug.TraceOggNative) { TDebug.out("adv: begin"); }
        OggLibrary.INSTANCE.oggpack_adv(handle, nBits);
        if (TDebug.TraceOggNative) { TDebug.out("adv: end"); }
    }
     ...
     */
    public void adv1() {
        if (TDebug.TraceOggNative) { TDebug.out("adv1: begin"); }
        OggLibrary.INSTANCE.oggpack_adv1(handle);
        if (TDebug.TraceOggNative) { TDebug.out("adv1: end"); }
    }
    ...
    public int read(int nBits) {
        if (TDebug.TraceOggNative) { TDebug.out("read: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_read(handle, nBits);
        if (TDebug.TraceOggNative) { TDebug.out("read: end"); }
        return nReturn.intValue();
    }
     ...
     */
    public int read1() {
        if (TDebug.TraceOggNative) { TDebug.out("read1: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_read1(handle);
        if (TDebug.TraceOggNative) { TDebug.out("read1: end"); }
        return nReturn.intValue();
    }
     ...
     */
    public int bytes() {
        if (TDebug.TraceOggNative) { TDebug.out("bytes: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_bytes(handle);
        if (TDebug.TraceOggNative) { TDebug.out("bytes: end"); }
        return nReturn.intValue();
    }
     ...
     */
    public int bits() {
        if (TDebug.TraceOggNative) { TDebug.out("bits: begin"); }
        NativeLong nReturn = OggLibrary.INSTANCE.oggpack_bits(handle);
        if (TDebug.TraceOggNative) { TDebug.out("bits: end"); }
        return nReturn.intValue();
    }
    ...
    public byte[] getBuffer() {
        if (TDebug.TraceOggNative) { TDebug.out("getBuffer: begin"); }
        ...
        if (TDebug.TraceOggNative) { TDebug.out("getBuffer: end"); }
        return abBuffer;
    }
}
